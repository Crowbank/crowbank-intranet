...
class Booking(Base):
    ...
    # Additional info
    boarding_type = Column(
        Enum(BoardingType), nullable=False, default=BoardingType.STANDARD
    )
    ...
    )  # Deprecated: use paid_amount property
    ...
    form_submissions = relationship(
        "FormSubmission",
        foreign_keys="FormSubmission.booking_id",
    ...
    def duration_days(self):
        ...
        return (self.departure_date - self.arrival_date).days + (
            1 if not self.is_daycare else 0
        )
