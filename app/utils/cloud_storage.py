...
class CloudStorageService:
    ...
    def upload_file(
        ...
        try:
            ...
            current_app.logger.error(f"Error uploading to R2: {e!s}")
            raise
    ...
    def get_download_url(
        ...
        try:
            ...
            current_app.logger.error(f"Error generating presigned URL: {e!s}")
            raise
    ...
    def delete_file(self, bucket_name: str, object_key: str) -> bool:
        ...
        try:
            ...
            current_app.logger.error(f"Error deleting object from R2: {e!s}")
            return False
